...
import 'package:flutter_application_1/components/centered_circular_progress.dart';
import 'package:flutter_application_1/components/centered_message.dart';
import 'package:flutter_application_1/components/finish_dialog.dart';
import 'package:flutter_application_1/components/result_dialog.dart';
...
class _QuizPageState extends State<QuizPage> {
  ...
  Expanded _buildQuestion(String question) {
    return Expanded(
      flex: 5,
      child: Padding(
  ...
  Expanded _buildAnswerButton(String answer) {
    return Expanded(
      child: Padding(
        ...
        child: GestureDetector(
          ...
          onTap: () {
            var correctAnswer = _controller.correctAnswer(answer);
            bool correct = correctAnswer;
